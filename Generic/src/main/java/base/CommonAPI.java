...
public class CommonAPI {
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false")String cloudEnvName,
                      @Optional("OS X") String os,@Optional("10") String os_version, @Optional("firefox") String browserName, @Optional("34")
                              String browserVersion, @Optional("https://trailhead.salesforce.com") String url)throws IOException {
        System.setProperty("webdriver.chrome.driver", "/Users/IDEAProjects/Salesforce-Automation-Project/Generic/browser-driver");
        if(useCloudEnv==true){
    ...
    public static void captureScreenshot(WebDriver driver, String screenshotName){
        ...
        try {
            FileUtils.newFileUtils().copyFile(file, new File(System.getProperty("user.dir")+ "/screenshots/"+screenshotName+" "+df.format(date)+".png"));
    ...
    public void takeScreenShot()throws IOException {
        File file = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.newFileUtils().copyFile(file,new File("screenShots.png"));
    }
    //Synchronization
