...
import java.util.function.Function;
	...
	private static AppiumDriver ad;
	private static AppiumDriverLocalService appiumLocal;
    private static WebDriverWait driverWait;
    private static File appDirectory;
    private static File findApp;
	private static int port = 4723;
	private static String nodeJSWinPath = "C:/Program Files/NodeJS/node.exe";
	private static String appiumJSWinPath = "C:/Program Files/Appium/node_modules/appium/bin/appium.js";
	private static String nodeJSMacPath = "/usr/local/bin/node";
	private static String appiumJSMacPath = "/usr/local/bin/node_modules/appium/build/lib/main.js";/*"/usr⁩/local⁩/⁨bin⁩/⁨node_modules⁩/⁨appium⁩/lib⁩/appium.js";*//*"/usr/local/bin/node";*//*"⁨usr⁩/local⁩/⁨bin⁩/⁨node_modules⁩/⁨appium⁩/lib⁩/appium.js";*/
//    public static ExtentReports extent;

////    @BeforeClass
////	    Call in a method preceding Given
//    public void extentSetup(ITestContext context) {
//        ExtentManager.setOutputDirectory(context);
//        extent = ExtentManager.getInstance();
//    }
////    @Before
////	    Call in (Given) or in a separate method in test class)
...
////	    @Parameters({"appName"})
////	    call this in (in Given) or annotate as Before in the test class
////    @After
//    public AppiumDriver afterEachTestMethod(AppiumDriver ad,/*@Optional("")*/ String appName, ITestResult result) {
...
//	    @BeforeMethod
//		Call this in startAppium
//	    Or this have to be part of the startAppium method
   
    public static AppiumDriver setUpAppiumDriver(AppiumDriver ad,String OS, String appType,String deviceType,String deviceName, String version,String moduleName,String appName,String appPackage,String appActivity)throws IOException,InterruptedException{

        String osName = System.getProperty("os.name");

        if (osName.contains("Mac")) {
            appiumLocal = AppiumDriverLocalService.buildService(new 
            AppiumServiceBuilder()
//            AppiumDriverLocalService.buildDefaultService();
                    .usingDriverExecutable(new File(nodeJSMacPath))
                    .withAppiumJS(new File(appiumJSMacPath/*"/usr/local/lib/node_modules/appium"*/))
    	...
    	if(OS.equalsIgnoreCase("ios")){
            if(appType.contains("iPhone")){
                ...
                if(deviceType.equalsIgnoreCase("RealDevice")){
                    ...
                    ad = setUpiOsEnv(deviceName,version);
//	 Just put iOS simulator capabilities here
                }
                ...
                if(deviceType.contains("RealDevice")){
                    ad = setUpiOsEnv(deviceName,version);
//	Just put iOS real device capabilities here
                }else if (deviceType.equalsIgnoreCase("Simulator")){
                    ad = setUpiOsEnv(deviceName,version);
//	Just put iOS simulator capabilities here
                }
...
//	Just put Android real device capabilities here	               
                }else if (deviceType.equalsIgnoreCase("Emulator")){
                    ad =setUpAndroidEnv(deviceName,version);
//	 Just put Android Emulator capabilities here   
                }
            }else if(OS.equalsIgnoreCase("Tablets")){
                if(deviceType.equalsIgnoreCase("RealDevice")){
                    ad = setUpAndroidEnv(deviceName,version);
//	Just put tablets real device capabilities here
                }else if (deviceType.equalsIgnoreCase("Emulator")){
                    ad = setUpAndroidEnv(deviceName,version);
//	Just put tablets emulator capabilities here
                }
            }
        }
		return ad;
    }
    public static AppiumDriver setUpiOsEnv(String deviceName,String version)throws IOException,InterruptedException{
    ...
    public static AppiumDriver setUpAndroidEnv(String deviceName,String version)throws IOException,InterruptedException{
        DesiredCapabilities cap = new DesiredCapabilities();
        cap.setCapability(MobileCapabilityType.DEVICE_NAME, deviceName);
...
//	        cap.setCapability(MobileCapabilityType.FULL_RESET, true);
        ...
        ad.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//        ScreenOrientation orientation = ad.getOrientation().LANDSCAPE;
//	        Thread.sleep(5000);
        return ad;
    }
    
//    public static void log(final String message, AppiumDriver driver) {
...
//    }
    ...
    public void swipeUpNDown(String locator) {
    	ad.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);	        //Get the size of screen.
        Dimension size = ad.manage().window().getSize();
        //Find swipe start and end point from screen's with and height.
